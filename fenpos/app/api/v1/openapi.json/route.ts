 ...
 * an install — it names no agent, no device and no job — and a client generator should not need a
 * credential to read one. `/api/health` is unauthenticated for a related reason and says as little
 * as possible; this says a great deal, and none of it is about this install.
 *
