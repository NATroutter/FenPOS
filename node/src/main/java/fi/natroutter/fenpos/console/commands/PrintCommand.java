 ...
 * <p>
 * Deliberately takes the same path as an HTTP request rather than a shortcut, so it proves
 * what a client would actually get — including markup errors and codepage rejections.
 */
public class PrintCommand extends DeviceCommand {
    ...
    private void submit(DeviceSettings device, String text) {
